...
insert into company(name,code,income,found_date,minor,creator_id,last_modifier_id) values('品友','ipinyou',1000000000.00,'1998-01-01',false,1,1),('别样','beyond',150000000.00,'2015-02-28',true,1,1),('中国移动','China mobile',500000000000.00,'1995-03-15',true,1,1);
