...
public abstract class LoginClientHandler {
	...
	public LoginClient createSaveLoginClient(User user, HttpServletRequest request, HttpServletResponse response) {
		...
		fillLoginClient(user, request, response, client);
	...
	protected abstract void fillLoginClient(User user, HttpServletRequest request, HttpServletResponse response, LoginClient client);
